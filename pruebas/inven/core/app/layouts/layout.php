...
<html>
  <head>
    ...
    <link rel="stylesheet" href="plugins/datatables/dataTables.bootstrap.css">
     <link href="plugins/stylo.css" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVENTARIO</b>PABIC</span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            <li class="header">ADMINISTRACCION</li>
            <?php if(isset($_SESSION["user_id"])):?>
                        <li><a href="./index.php?view=home"><i class='fa fa-home'></i> <span>Inicio</span></a></li>
            <li><a href="./?view=sell"><i class='fa fa-usd'></i> <span>Nueva Salida</span></a></li>
            <li><a href="./?view=sells"><i class='fa fa-shopping-cart'></i> <span>Salidas</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <!--<li><a href="./?view=sellreports">Salidas</a></li>-->
              </ul>
            </li>
